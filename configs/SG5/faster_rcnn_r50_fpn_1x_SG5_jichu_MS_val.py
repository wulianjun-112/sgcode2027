...
# dataset settings
train_class = ['立柱淹没', '杂物堆积']

sub_dataset_name = '基础'

val_classes = train_class
dataset_type = 'SG4'
data_root = '/data1/wlj/StateGridv5/{}'.format(sub_dataset_name)
val_data_root = '/data1/wlj/StateGridv5/验证集/{}'.format(sub_dataset_name)
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            ann_file='/data1/wlj/StateGridv5/{}/ImageSets/Main/train.txt'.format(sub_dataset_name),
    ...
    val=dict(
        type=dataset_type,
        ann_file='/data1/wlj/StateGridv5/验证集/{}/ImageSets/Main/val.txt'.format(sub_dataset_name),
