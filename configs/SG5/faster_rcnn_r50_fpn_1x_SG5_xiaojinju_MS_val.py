...
dataset_type = 'SG4'
data_root = '/data/wulianjun/StateGridv5/小金具'
val_data_root = '/data/wulianjun/StateGridv5/验证集/小金具'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        # dataset=dict(
            type=dataset_type,
            ann_file='/data/wulianjun/StateGridv5/小金具/ImageSets/Main/train.txt',
    ...
    val=dict(
        type=dataset_type,
        ann_file='/data/wulianjun/StateGridv5/验证集/小金具/ImageSets/Main/val.txt',
